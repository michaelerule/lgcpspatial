...
project = u'Fast Log-Gaussian Point-Process Methods for Grid Cells'
copyright = u'2020–2022, M. E. Rule; P. Chaudhuri-Vayalambrone'
author = u'M. E. Rule; P. Chaudhuri-Vayalambrone'
...
latex_documents = [
    (master_doc, 'gclgcp.tex', u'Neurotools Documentation',u'M. E. Rule', 'manual'),
]
...
man_pages = [
    (master_doc, 'GC-LGCP', u'Neurotools Documentation',[author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GC-LGCP', u'Documentation for "%s"'%project,author,'GC-LGCP',project,'Miscellaneous'),
]
...
autodoc_mock_imports = ["pylab", 'numpy', 'scipy','scipy.fft','scipy.fftpack','numpy.random','matplotlib','matplotlib.pyplot']
